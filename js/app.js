...
(function () {
  ...
  function injectChrome() {
    var pages = [
      ...
      ["financials.html", "nav.financials", [["financials.html", "nav.dd.unit"], ["costings.html", "nav.dd.costings"], ["costings-riyadh.html", "nav.dd.costingsRy"], ["financials.html#proj", "nav.dd.proj"]]],
    ...
    for (var i = 0; i < pages.length; i++) {
      var p = pages[i];
      var isFinGrp = p[0] === "financials.html" && (path === "financials.html" || path === "costings.html" || path === "costings-riyadh.html");
